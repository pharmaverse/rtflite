...
class TestPageDict:
    ...
    def test_get_rows_for_page(self):
        ...
        page_dict.add_page_config(PageConfig(1, 0, 9, PageBreakType.AUTOMATIC))
        page_dict.add_page_config(PageConfig(2, 10, 14, PageBreakType.FORCED))  # Partial page
...
class TestPageIndexManager:
    ...
    def test_complex_page_dict_scenario(self):
        ...
        assert 2 >= page_dict.get_page_config(1).start_row and 2 <= page_dict.get_page_config(1).end_row
        # Row 7 should be on page 2 (5-9)
        assert 7 >= page_dict.get_page_config(2).start_row and 7 <= page_dict.get_page_config(2).end_row
        # Row 11 should be on page 3 (10-12)
        assert 11 >= page_dict.get_page_config(3).start_row and 11 <= page_dict.get_page_config(3).end_row