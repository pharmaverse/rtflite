...
class TestSinglePageColumnHeaders:
    ...
    def test_multi_level_header_with_borders(self):
        ...
        assert_rtf_equals_semantic(rtf_output, expected, "test_multi_level_header_borders")
    ...
    def test_header_text_justification(self):
        ...
        assert_rtf_equals_semantic(rtf_output, expected, "test_header_text_justification")
...
class TestSinglePageBody:
    ...
    def test_body_border_combinations(self):
        ...
        assert_rtf_equals_semantic(rtf_output, expected, "test_body_border_combinations")
    ...
    def test_body_cell_height_variations(self):
        ...
        assert_rtf_equals_semantic(rtf_output, expected, "test_body_cell_height_variations")
    ...
    def test_body_font_size_per_column(self):
        ...
        doc = rtf.RTFDocument(
            ...
            rtf_body=rtf.RTFBody(
                col_rel_width=[1, 1, 1],
                text_font_size=[7, 9, 12]
            )
        )
        
        rtf_output = doc.rtf_encode()
        expected = r_output.read("body_font_size_per_column")
        assert_rtf_equals_semantic(rtf_output, expected, "test_body_font_size_per_column")
    ...
    def test_title_header_body(self):
        ...
        doc = rtf.RTFDocument(
            ...
            rtf_title=rtf.RTFTitle(
                text=["Clinical Trial Results", "Study XYZ-123"],
                text_format=["b", ""]
            ),
            rtf_column_header=[
                rtf.RTFColumnHeader(
...
class TestSinglePageTextConversion:
    ...
    def test_special_chars_in_headers(self):
        ...
        assert_rtf_equals_semantic(rtf_output, expected, "test_special_chars_in_headers")
