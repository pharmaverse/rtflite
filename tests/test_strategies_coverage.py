...
import polars as pl
from rtflite import (
    RTFDocument, RTFBody, RTFTitle, RTFFootnote, RTFSource,
    RTFColumnHeader, RTFFigure, RTFPage, RTFPageHeader, RTFPageFooter
)
...
class TestStrategyErrorConditions:
    ...
    def test_page_by_empty_section(self):
        ...
        doc = RTFDocument(
            df=df,
            rtf_body=RTFBody(page_by=["Group"])
        )
