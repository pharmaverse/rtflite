...
from .utils_snapshot import assert_rtf_equals_without_fonts, assert_rtf_equals_structural, assert_rtf_equals_semantic
...
def test_pagination_basic_with_headers():
    ...
    assert_rtf_equals_semantic(rtf_output, expected, "test_pagination_basic_with_headers")
