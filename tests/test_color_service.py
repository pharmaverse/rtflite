...
class TestColorService:
    ...
    def test_validate_color_valid(self):
        ...
        valid_colors = ["black", "red", "blue", "orange", "lightcoral", "darkseagreen", "white"]
    ...
    def test_get_color_rtf_code(self):
        ...
        assert self.color_service.get_color_rtf_code("black") == "\\red0\\green0\\blue0;"
        assert self.color_service.get_color_rtf_code("red") == "\\red255\\green0\\blue0;"
        assert self.color_service.get_color_rtf_code("orange") == "\\red255\\green165\\blue0;"
    ...
    def test_backwards_compatibility_functions(self):
        ...
        from rtflite.services.color_service import validate_color, get_color_index, get_color_suggestions
...
class TestConditionalColorTable:
    ...
    def test_rtf_generation_conditional_color_table(self):
        ...
        doc_with_colors = RTFDocument(
            df=pl.DataFrame({"col": ["test"]}),
            rtf_body=RTFBody(text_color="orange")
        )
...
class TestNewColorSupport:
    ...
    def test_comprehensive_color_coverage(self):
        ...
        test_colors = [
            "aliceblue", "antiquewhite", "aquamarine",  # A colors
            "beige", "bisque", "blanchedalmond",  # B colors
            "chartreuse", "chocolate", "coral",  # C colors
            "darkblue", "darkcyan", "darkgoldenrod",  # Dark colors
            "lightblue", "lightcoral", "lightgreen",  # Light colors
            "mediumaquamarine", "mediumblue", "mediumorchid",  # Medium colors
            "palegreen", "paleturquoise", "palevioletred",  # Pale colors
        ]
