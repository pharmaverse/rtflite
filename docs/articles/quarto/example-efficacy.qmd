...
This example demonstrates how to create a multi-section efficacy table using rtflite's Phase 1 multi-section functionality. The table shows ANCOVA analysis results with multiple sections: summary statistics, treatment comparison, and model diagnostics.
