...
For single-page documents, all components appear regardless of the `page_title`, `page_footnote`, and `page_source` settings:
...
These settings provide fine-grained control over component placement in multi-page documents, allowing you to create professional reports that meet specific formatting requirements for regulatory submissions and clinical reporting.