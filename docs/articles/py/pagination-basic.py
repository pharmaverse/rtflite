...
doc_advanced = rtf.RTFDocument(
    ...
    rtf_page_header=rtf.RTFPageHeader(text="CONFIDENTIAL - Study ABC-123"),
    rtf_page_footer=rtf.RTFPageFooter(text="Page {PAGE} of {NUMPAGES}"),
    rtf_title=rtf.RTFTitle(
        text=[
            "Complete Patient Listing",
